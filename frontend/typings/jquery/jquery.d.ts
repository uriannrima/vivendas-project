...
interface JQuery {
    ...
    */
    ...
    /**
     * Utilizar método de typeahead do typeahead-2.0.3.js.
     * Método já existe dentro do objeto JQuery, porém o Typescript não consegue encontra-lo, mapeando aqui, o Typescript para de reclamar
     * e é possível fazer passagem de parametros para o método.
     * 
     ...
     * e é possível fazer passagem de parametros para o método.
     * 
     * @param mask String contendo formatação da máscara.
     * @param options Opções adicionais como eventos de complete, novos templates, etc.
     */
